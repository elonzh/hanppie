...
@Composable
internal fun DevicePage(model: ConsoleModel, state: ConsoleState, compact: Boolean, modifier: Modifier,
...
@Composable
private fun DeviceActions(model: ConsoleModel, state: ConsoleState, onManual: () -> Unit, onRemote: () -> Unit) {
