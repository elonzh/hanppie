...
internal data class ConsoleState(
    ...
    fun lost(reason: String): ConsoleState = copy(connected = false, connectedAddress = null, statusMessage = uiText(Res.string.connection_lost), error = reason,
        uploadedSource = null, battery = null, values = emptyList(), gimbal = null, scriptMessage = uiText(Res.string.connection_lost_robot_execution_state_unknown))
}
