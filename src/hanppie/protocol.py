...
__all__ = [
    ...
    "CMD_GIMBAL_EXT_CTRL_ACCEL",
    "CMD_GIMBAL_ROTATE_SPEED",
    "CMD_RM_AUDIO_TO_APP",
    "CMD_RM_AUDIO_TRANSFER",
    "CMD_RM_CUSTOM_UI_ATTRIBUTE_SET",
    "CMD_RM_EXIT_LOW_POWER_MODE",
    "CMD_RM_FC_RMC",
    "CMD_RM_GAMECTRL_CMD",
    "CMD_RM_GAME_STATE_SYNC",
    "CMD_RM_GET_SIGHT_BEAD_POSITION",
    "CMD_RM_GET_SPEAKER_VOLUME",
    "CMD_RM_GUN_LED_SET",
    "CMD_RM_LED_COLOR_SET",
    "CMD_RM_MODULE_STATUS_PUSH",
    "CMD_RM_PLAY_SOUND",
    "CMD_RM_PLAY_SOUND_TASK",
    "CMD_RM_PRODUCT_ATTRIBUTE_GET",
    "CMD_RM_SAVE_PREF",
    "CMD_RM_SCRIPT_BLOCK_STATUS_PUSH",
    "CMD_RM_SCRIPT_CTRL",
    "CMD_RM_SCRIPT_CUSTOM_INFO_PUSH",
    "CMD_RM_SCRIPT_DOWNLOAD_DATA",
    "CMD_RM_SCRIPT_DOWNLOAD_FINSH",
    "CMD_RM_SET_AUDIO_STATUS",
    "CMD_RM_SET_SPEAKER_VOLUME",
    "CMD_RM_SHOOT_CMD",
    "CMD_RM_SPECIAL_CONTROL",
    "CMD_RM_SPEED_MODE_SET",
    "CMD_RM_SPEED_SET",
    "CMD_RM_STREAM_CTRL",
    "CMD_RM_SUB_MOBILE_INFO",
    "CMD_RM_SYSTEM_FUNCTION_CONFIG",
    "CMD_RM_SYSTEM_STATUS_CONFIG",
    "CMD_RM_WHEEL_SPEED_SET",
    "CMD_RM_WORK_MODE_SET",
    "CMD_SET_VIDEO_FORMAT",
    "CMD_SET_ZOOM_PARAM",
    "CMD_SPECIAL_RM_CONTROL",
    "CMD_VBUS_ADD_MSG",
    "CMD_VBUS_ADD_NODE",
    "CMD_VBUS_DATA_ANALYSIS",
    "CMD_VBUS_DEL_MSG",
    "CMD_VBUS_NODE_RESET",
    "CMD_VISION_CUSTOM",
    "CMD_WIFI_AP_KEEPALIVE",
    "CMD_WIFI_AP_PUSH_RSSI",
    "CMD_WIFI_AP_SET_COUNTRY_CODE",
    "CMD_WIFI_CONFIG_BY_QRCODE",
    "CMD_WIFI_GET_WORK_MODE",
    "CRC8_INIT",
    "CRC16_INIT",
    "DUSS_MAGIC",
    ...
    "ROBOT_CONTROL_PORT",
    "ROBOT_FTP_PORT",
    "SCRIPT_CTRL_METADATA_FULL",
    "SCRIPT_CTRL_METADATA_GUID",
    "SCRIPT_CTRL_START",
    "SCRIPT_CTRL_STOP",
    "AppEnvelope",
    "DussFrame",
...
CMD_RM_SET_SPEAKER_VOLUME = 0x1B
CMD_RM_GET_SPEAKER_VOLUME = 0x1C
