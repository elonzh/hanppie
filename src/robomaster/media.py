...
# Modified by Hanppie: DJI did not publish ``libmedia_codec`` for macOS or
# Python 3.10. Prefer the native extension when present and otherwise use the
# API-compatible PyAV implementation bundled with Hanppie.
try:
